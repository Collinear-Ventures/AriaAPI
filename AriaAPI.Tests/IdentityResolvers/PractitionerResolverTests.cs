...
{
    /// <summary>
    /// Tests for <see cref="PractitionerResolver"/> constructor null guards.
    /// </summary>
    public sealed class PractitionerResolverTests
    {
        /// <summary>
        ...
        public void Constructor_NullConfigurator_ThrowsArgumentNullException()
        {
            var ex = Assert.Throws<ArgumentNullException>(() =>
                new PractitionerResolver(null!, NullLogger<PractitionerResolver>.Instance));
        ...
        public void Constructor_NullLogger_ThrowsArgumentNullException()
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(() =>
                new PractitionerResolver(configurator, null!));
